...
const scenes = {
  ...
  carInterior: {
    ...
    hotspots() { return [
      ...
      { id: "exit-car", label: "Get Out", x: 78, y: 28, w: 14, h: 34, action() { setScene("parkingLot"); } },
  ...
  entrance: {
    ...
    hotspots() { return [
      { id: "mailbox", label: "Check Mailbox", x: 10, y: 38, w: 18, h: 26, action() { setScene("entranceMailbox"); } },
      { id: "door", label: state.flags.codeDiscovered ? "Inspect Keypad" : "Inspect Door Keypad", x: 42, y: 18, w: 22, h: 56, action() { setScene("entranceKeypad"); } },
      { id: "back-parking", label: "Back to Parking Lot", x: 76, y: 40, w: 16, h: 22, action() { setScene("parkingLot"); } }
    ]; }
  },
  entranceMailbox: {
