        ...
        action() {
          ...
          collectDocument({
            ...
            body: [
              ...
              "证件代办咨询（加急）",
              "",
              "几张纸互相覆盖，角落钉着一条窄窄的小广告。"
            ].join("\n")
          });

          collectDocument({
            id: "chapter2-roadside-divination-strip",
            title: "夹在缝里的占卜小广告",
            source: "住院部外路边广告牌角落",
            body: [
              "手写小条，只有半掌宽：",
          ...
          addNote("你在诊所楼下翻到一堆杂乱传单。");
          showMessage("你靠在车门边深呼吸，顺手翻了翻路边广告牌：搬家、保洁、课程、代办贴得密密麻麻。");
        }
      }
    ];
  }
