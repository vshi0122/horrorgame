...
func reset() -> void:
	...
	flags = {
		...
		"stairwell_photo_jumpscare_played": false,
		"stairwell_photo_reaction_pending": false,
		"stairwell_photo_footsteps_active": false,
		"third_floor_blackout_intro_played": false,
		"third_floor_flashlight_enabled": false,
		"first_fake_third_floor_seen": false,
